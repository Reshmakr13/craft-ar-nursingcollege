...
<div class="items-center">
    ...
    <nav class="flex lg:flex-col md:flex flex-col  mb-6 lg:mb-0 lg:w-full">
            ...
            <div class="lg:flex md:flex md:items-center md:mb-0 lg:items-center mb-2">
                ...
                <div class="hidden md:block md:flex md:justify-start md:px-16 md:ml-3 md:items-center md:text-right md:mr-0 md:space-x-6 md:font-light md:w-3/4 md:text-base lg:text-right lg:justify-end  lg:block lg:mr-0 lg:font-light font-questrial font-thin lg:py-8 lg:w-3/4  lg:space-x-8 lg:text-xl">
                    ...
                    <a @click="$dispatch('linkaction', {link: '{{route('gallery')}}', route: 'gallery'})"class="text-teal font-bold underline">Gallery</a>
    ...
    <div class="ml-4 mr-4 mt-8 lg:mt-28 lg:ml-16 lg:mr-16">
        <div class=""><h class="text-xl font-semibold font-inter text-black lg:text-6xl">News & Articles</h></div>
        <p class="text-sm text-justify font-extralight font-inter  mt-3 lg:text-base lg:mt-6 lg:leading-6 lg:pr-16">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctusnec ullamcorper mattis, pulvinar dapibus leo.Lorem ipsum dolor
    ...
    <div class="mt-16 mb-6 ml-4 lg:ml-16">
        <h class="text-sm font-inter font-extrabold text-align-center text-base-100 border border-teal bg-teal px-12 py-3 lg:text-2xl lg:py-4">Advancing knowledge</h>
    </div>

    <div class="ml-4 mr-4 lg:ml-16 lg:mr-16 lg:mt-20">
        <img src="{{url('/images/4.jpg')}}" class="bg-cover w-full lg:w-2/3" alt="image">
    </div>

    <div class="lg:mt-24 mt-2">
        <p class="text-justify leading-4 text-sm mr-8 ml-6 mt-4 font-gothic font-normal text-black lg:text-base lg:leadind-5 lg:ml-16 lg:text-left lg:mr-20">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,
            when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap 
            into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum
             passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum
        </p>

        <p class="text-justify leading-4 text-sm mr-8 ml-6 mt-4 font-gothic font-normal text-black lg:text-base lg:leadind-5 lg:ml-16 lg:text-left lg:mr-20">
    ...
    <div>
        <div class="lg:mt-16 ml-4 mr-4 lg:flex flex-row hidden lg:block">
            <div class="max-w-sm mx-auto bg-white shadow-lg overflow-hidden mt-4 mb-10 lg:1/3">
                ...
                <div class="px-4 py-4 mt-2">
                    <p class=" text-sm font-extralight text-black font-gothic lg:text-sm">
                    ...
                    <div class="lg:flex flex-row-reverse">
                        <div class="lg:ml-12">
                            <ul class="list-disc text-white mt-6 ">
                                <div><h class="text-white font-inter text-base mb-2 lg:text-xl lg:font-normal font-inter">Quick Links</h></div>
