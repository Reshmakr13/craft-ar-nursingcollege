...
<div class="items-center">
    ...
    <div class="ml-4 mr-4 mt-8 md:mt-36 md:ml-16 md:mr-16">
    ...
    <div class="mt-16 mb-6 ml-4 md:ml-16">
        <h class="text-sm font-inter font-extrabold text-align-center text-base-100 border border-teal bg-teal px-12 py-3 md:text-2xl md:py-4">Advancing knowledge</h>
    </div>

    <div class="ml-4 mr-4 md:ml-16 md:mr-16 md:mt-20">
        <img src="{{url('/images/4.jpg')}}" class="bg-cover w-full md:w-2/3" alt="image">
    </div>
    ...
    <div>
        <div class="md:mt-16 ml-4 mr-4 md:flex flex-row hidden md:block">
