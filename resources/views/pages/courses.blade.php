...
<div> class="items-center">
    ...
    <header>
        <nav class="flex md:flex-col mb-6 md:mb-0">
            ...
            <div class="md:flex md:item-center mb-2">
                ...
                <div class="hidden md:text-right md:block md:mr-28 md:font-light font-thin font-gothic md:py-8 md:w-2/3 md:space-x-16 md:text-xl">
    ...
    <div>
        <div class="relative ">
            <img src="{{url('/images/coursesd1.png')}}" class="md:w-full md:bg-cover hidden md:block " alt="image">
            <img src="{{url('/images/coursesm1.png')}}" class=" w-full  bg-cover md:hidden" alt="image">
            <div class="absolute inset-0 overflow-hidden  bg-gradient-to-r from-secondary/20 to-accent/20">
                <div class="md:text-left ml-6 mt-40 md:mt-96 md:ml-32 -mr-6">
                            <div class=""><h class="text-white text-xs md:text-lg outline outline-white outline-1 font-normal font-inter md:px-2 md:py-2  pt-1 pb-1 mr-14 pl-1 pr-1">ACADEMICS</h></div>
                            <p class=" text-left text-white text-xl mt-4 md:text-7xl md:leading-tight font-bold font-inter mr-10 md:mt-6 ">DIPLOMA IN GENERAL <br> NURSING & MIDWIFERY-3 YEARS</p>
    ...
    <div>
        <div class="mt-4 text-left ml-4 md:ml-20 md:mt-16">
            <h class="text-teal text-sm font-bold font-inter md:text-3xl">DIPLOMA IN GENERAL NURSING & MIDWIFERY-3 YEARS</h><br>
            <div class="md:mt-12"><h class="text-teal text-xs font-bold font-inter md:text-xl">WELCOME TO CRAFT SCHOOL OF NURSING</h></div>
        </div>

        <div>
            <div class="flex mt-4 ml-6 items-center md:ml-20">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 md:h-5 md:w-5  fill-teal" viewBox="0 0 512 512">
                    <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                    <path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM369 209L241 337c-9.4 9.4-24.6 9.4-33.9 0l-64-64c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l47 47L335 175c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9z"/>
                </svg>
                <p class="text-xs text-black font-semibold font-inter  ml-2 md:text-lg">Feature 1</p>
            </div>
            <div class="mt-6 ml-4">
                <p class="text-justify leading-4 text-xs mr-8 ml-6 font-gothic font-normal text-black md:text-base md:leadind-5 md:ml-20 md:text-left md:mr-20">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's 
                ...
                <p class="text-justify leading-4 text-xs mr-8 ml-6 mt-4 font-gothic  font-normal text-black md:text-base md:leadind-5 md:ml-20 md:text-left md:mr-20">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC,
                ...
                <p class="text-justify leading-4 text-xs mr-8 ml-6 mt-4 font-gothic r font-normal text-black md:text-base md:leadind-5 md:ml-20 md:text-left md:mr-20">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.
        ...
        <div>
            <div class="flex mt-10 ml-6 items-center md:ml-20 md:mt-20">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 md:h-5 md:w-5  fill-teal" viewBox="0 0 512 512">
                    <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                    <path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM369 209L241 337c-9.4 9.4-24.6 9.4-33.9 0l-64-64c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l47 47L335 175c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9z"/>
                </svg>
                <p class="text-xs text-black font-semibold font-inter  ml-2 md:text-lg">Feature 2</p>
            </div>
            <div class="mt-6 ml-4">
                <p class="text-justify leading-4 text-xs mr-8 ml-6 font-gothic  font-normal text-black md:text-base md:leadind-5 md:ml-20 md:text-left md:mr-20">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's 
                    standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. 
                ...
                <p class="text-justify leading-4 text-xs mr-8 ml-6 mt-4 mb-4 font-gothic  font-normal text-black md:text-base md:leadind-5 md:ml-20 md:text-left md:mr-20 md:mb-48">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.
                     The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here,content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover 
                     many web sites still in their infancy.Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).
                </p>
            </div>
        ...
        <div class="inset-0 overflow-hidden  bg-gradient-to-b from-elm/100 to-teal/70 ">
            <div class="md:flex flex-row-reverse md:mt-4 md:mb-12 mb-6">
                <div class="mt-4 ml-10  md:w-1/2 md:flex flex-row md:pr-12">
                    <div class="md:mt-6 ">
                        <div><h class="text-white text-base mb-2 md:text-xl md:font-normal">Reach us</h></div>
                        <p class="text-white font-light leading-6 text-xs mt-2 md:font-normal font-inter">CRAFT HOSPITAL AND RESEARCH<br> CENTRE,VIII/77/ 2,3,4, Kodungallur P.O,<br> Chanthappura,Kodungallur, Thrissur,<br> Kerala Ph:+91 6282396564</p>
