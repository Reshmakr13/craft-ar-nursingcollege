...
<div class="items-center">
    ...
    <header>
        ...
        <div class="flex flex-row">
            ...
            <div class="lg:flex lg:item-center mb-2">
                ...
                <div class="hidden lg:text-right lg:block lg:mr-12 lg:font-light font-thin font-gothic lg:py-8 lg:w-2/3 lg:space-x-16 lg:text-xl">
    ...
    <div>
        <div class="relative ">
            ...
            <div class="absolute inset-0 overflow-hidden  bg-gradient-to-r from-secondary/20 to-accent/20">
                <div class="lg:text-left ml-6 mt-40 lg:mt-96 lg:ml-32 -mr-6">
                            <div class=""><h class="text-white text-sm lg:text-lg outline outline-white outline-1 font-normal font-inter lg:px-2 lg:py-2  pt-1 pb-1 mr-14 pl-1 pr-1">ACADEMICS</h></div>
                            <p class=" text-left text-white text-xl mt-4 lg:text-7xl lg:leading-tight font-bold font-inter mr-10 lg:mt-6 ">DIPLOMA IN GENERAL <br> NURSING & MIDWIFERY-3 YEARS</p>
    ...
    <div>
        <div class="mt-4 text-left ml-4 lg:ml-20 lg:mt-16">
            <h class="text-teal text-sm font-bold font-inter lg:text-3xl">DIPLOMA IN GENERAL NURSING & MIDWIFERY-3 YEARS</h><br>
            <div class="lg:mt-12"><h class="text-teal text-sm font-bold font-inter lg:text-xl">WELCOME TO CRAFT SCHOOL OF NURSING</h></div>
        </div>

        <div>
            <div class="flex mt-4 ml-6 items-center lg:ml-20">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 lg:h-5 lg:w-5  fill-teal" viewBox="0 0 512 512">
                    <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                    <path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM369 209L241 337c-9.4 9.4-24.6 9.4-33.9 0l-64-64c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l47 47L335 175c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9z"/>
                </svg>
                <p class="text-sm text-black font-semibold font-inter  ml-2 lg:text-lg">Feature 1</p>
            </div>
            <div class="mt-6 ml-4">
                <p class="text-justify leading-4 text-sm mr-8 ml-6 font-gothic font-normal text-black lg:text-base lg:leadind-5 lg:ml-20 lg:text-left lg:mr-20">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's 
                ...
                <p class="text-justify leading-4 text-sm mr-8 ml-6 mt-4 font-gothic  font-normal text-black lg:text-base lg:leadind-5 lg:ml-20 lg:text-left lg:mr-20">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC,
                ...
                <p class="text-justify leading-4 text-sm mr-8 ml-6 mt-4 font-gothic r font-normal text-black lg:text-base lg:leadind-5 lg:ml-20 lg:text-left lg:mr-20">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.
        ...
        <div>
            <div class="flex mt-10 ml-6 items-center lg:ml-20 lg:mt-20">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 lg:h-5 lg:w-5  fill-teal" viewBox="0 0 512 512">
                    <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                    <path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM369 209L241 337c-9.4 9.4-24.6 9.4-33.9 0l-64-64c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l47 47L335 175c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9z"/>
                </svg>
                <p class="text-sm text-black font-semibold font-inter  ml-2 lg:text-lg">Feature 2</p>
            </div>
            <div class="mt-6 ml-4">
                <p class="text-justify leading-4 text-sm mr-8 ml-6 font-gothic  font-normal text-black lg:text-base lg:leadind-5 lg:ml-20 lg:text-left lg:mr-20">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's 
                    standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. 
                ...
                <p class="text-justify leading-4 text-sm mr-8 ml-6 mt-4 mb-4 font-gothic  font-normal text-black lg:text-base lg:leadind-5 lg:ml-20 lg:text-left lg:mr-20 lg:mb-48">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.
                     The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here,content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover 
                     many web sites still in their infancy.Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).
                </p>
            </div>
            ...
            <div class="relative">
                ...
                <div class="absolute inset-0 overflow-hidden  bg-gradient-to-r from-submarine/100 to-teal/10 lg:bg-gradient-to-r from-cyan/80 to-teal/10">
                    <div class="ml-6 mt-8 mb-20 lg:mt-40 lg:ml-16">
                        ...
                        <div class="lg:mr-96 lg:pr-64"><p class="font-inter text-white font-thin leading-4 text-sm lg:text-sm lg:mt-12 lg:mr-96">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctusnec ullamcorper mattis,
                             pulvinar dapibus leo.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, .</p></div>
                            <button class="text-center flex items-center font-arial font-bold lg:text-2xl text-white mt-4 bg-teal text-sm p-2 lg:mt-28 lg:py-3 lg:px-5 mr-52" type="button">
                                        APPLY NOW
                    ...
                    <div>
                        <div class="inset-0 overflow-hidden  bg-gradient-to-b from-teal/100 to-teal/50  mt-28 pb-16 lg:mt-72 lg:ml-16 lg:mr-16">
                            <div class="ml-4 lg:mt-16 lg:ml-16">
                                ...
                                <p class="text-white font-extralight font-inter text-sm mt-4">Enter your email to subscribe to our mailing list.</p>
        ...
        <div class="inset-0 overflow-hidden  bg-gradient-to-b from-elm/100 to-teal/70 ">
            <div class="lg:flex flex-row-reverse lg:mt-4 lg:mb-12 mb-6">
                <div class="mt-4 ml-10  lg:w-1/2 lg:flex flex-row lg:pr-12">
                    <div class="lg:mt-6 ">
                        <div><h class="text-white text-base mb-2 lg:text-xl lg:font-normal">Reach us</h></div>
                        <p class="text-white font-light leading-6 text-sm mt-2 lg:font-normal font-inter">CRAFT HOSPITAL AND RESEARCH<br> CENTRE,VIII/77/ 2,3,4, Kodungallur P.O,<br> Chanthappura,Kodungallur, Thrissur,<br> Kerala Ph:+91 6282396564</p>
                    ...
                    <div class="lg:flex flex-row-reverse">
                        <div class="lg:ml-12">
                            <ul class="list-disc text-white mt-6 ">
                                <div><h class="text-white text-base mb-2 lg:text-xl lg:font-normal font-inter">Quick Links</h></div>
                                    ...
                                    <li class="ml-6"><a @click="$dispatch('linkaction', {link: '{{route('contact')}}', route: 'contact'})"><p class="text-white font-light leading-6 text-sm mt-2 lg:font-normal font-inter">Contact Us </p></a></li>
                                    <li class="ml-6"><a @click="$dispatch('linkaction', {link: '{{route('gallery')}}', route: 'gallery'})"><p class="text-white font-light leading-6 text-sm mt-2 lg:font-normal font-inter">Gallery</p></a></li>
                            </ul>
                        </div>
                        <div class="lg:ml-6">
                            <ul class="list-disc text-white mt-6 ">
