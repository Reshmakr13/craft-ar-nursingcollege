...
<div>
    ...
    <div class="md:flex flex-row md:ml-32 md:mb-20">
        ...
        <div class="mt-48 relative ml-4 mb-40 flex flex-reverse items-center md:w-1/2">
            <div class=" bg-primary h-96 py-80  px-12 md:px-0 absolute right-0 md:py-96 w-1/2"></div>
            <div class="bg-black w-96 md:w-2/3 mr-6 z-10">
                <div class="ml-4 mt-8">
