...
<div class="items-center">
    ...
    <div class="md:flex flex-row md:ml-32 md:mb-20">
        <div class="mt-10 md:mt-48">
            <div class="ml-4">
                ...
                @endif
                    <form method="POST" action="{{route('contact.submit')}}">
                        @csrf
                        <div class="relative mt-4 mr-4 md:mr-0 ">
                            <input id="name" name="name" type="text"
                                ...
                                placeholder="Name"/>
                            <label for="name"
                                class="absolute left-0 -top-3.5 text-black text-sm md:text-xl transition-all peer-placeholder-shown:text-sm peer-placeholder-shown:md:text-xl peer-placeholder-shown:text-black
                                 peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-black peer-focus:text-sm font-gothic">Name
                            </label>
                        </div>
                        <div class="relative mt-4 md:mt-16 mr-4 md:mr-0 ">
                            <input id="email" name="email" type="email"
                                class="w-full h-10 text-gray-900 placeholder-transparent border-0 border-b border-black peer focus:outline-none focus:border-0 border-b
                                 border-black"
                                placeholder="Email" />
                            <label for="email"
                                class="absolute left-0 -top-3.5 text-black text-sm transition-all peer-placeholder-shown:text-sm peer-placeholder-shown:md:text-xl peer-placeholder-shown:text-black
                        ...
                        <div class="mt-6 items-center text-center md:mt-16">
                            <button class="text-base font-bold font-gothic text-white bg-primary px-28 py-1.5 md:text-2xl md:px-64 md:py-3 font-gothic tracking-widest">SEND</button>
                        </div>
    ...
    <div class="mt-48 relative ml-4 mb-40 flex justfy-end items-center md:ml-96">
        <div class=" bg-primary h-96 py-80  px-12 md:px-60 absolute right-0 md:py-96 md:-mr-80 "></div>
        <div class="bg-black w-96 md:w-full mr-6 z-10 md:pr-12 md:pl-20">
            <div class="ml-8 md:-ml-8 mt-8 ">
                ...
                <div class="flex mt-16 items-center">
                    ...
                    <p class="text-white text-xs font-gothic ml-28 md:text-sm">craftnursingcollege.com</p>
                </div>
                <div class="flex mt-16 items-center">
                <p class="text-white text-xs font-bold font-gothic md:text-2xl">Phone No.</p>
                <p class="text-white text-xs font-gothic ml-16 md:text-sm">+91 9526986000</p>
                </div>
                <div class="flex mt-16 ">
                <p class="text-white text-xs font-bold font-gothic md:text-2xl">Address</p>
                <div class="flexflex-col mb-16">
                    <p class="text-white text-xs font-inter mb-4 ml-16 md:text-sm">CRAFT HOSPITAL AND RESEARCH<br> CENTRE,VIII/77/ 2,3,4, Kodungallur P.O,<br> Chanthappura,Kodungallur, Thrissur, Kerala</p>
                    <p class="text-white text-xs font-inter mb-4 ml-16 md:text-sm">CRAFT Multispeciality Centre5th & 6th Floor,<br> Imperial Amity,Chalikkavattam, NH66 <br>BypassKochi 682032, kerala</p>
                </div> 
                </div>
            </div>
        </div>
