...
<div class="items-center">
            ...
            <div class="md:flex md:flex-row hidden md:block md:bg-primary md:w-full p-4 ">
                <div class="flex flex-row">
                    <div class="flex ml-10 items-center">
                        ...
                        <p class="text-white ml-2 font-light ">0480-2800200</p>
                    </div>
                    ...
                    <div class="flex ml-32 items-center">
                        ...
                        <p class="text-white ml-2 font-questrial font-light">nursingschool@craftivf.com</p>
                    </div>
        ...
        <div class="relative ">
            ...
            <div class="absolute inset-0 overflow-hidden  bg-gradient-to-r from-secondary/40 to-accent/50">
                <div class="md:text-left ml-14 mt-28 md:mt-60 md:ml-32 -mr-6">
                            ...
                            <div class="md:mr-96 md:pr-4"><p class=" text-left text-white text-xs  md:text-base font-gothic mt-12 font-light  mr-24 md:mr-96 md:text-lg md:font-normal md:leading-6" >It is a long established fact that a reader will be distracted 
    ...
    <div>
        <div class="text-center md:text-left">
            ...
            <p class="text-justify leading-4 text-xs mr-6 ml-6 font-gothic text-black md:text-lg/[22px] md:leadind-5 md:ml-20 md:text-left md:mr-20">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text
            ...
            <p class="text-justify leading-4 text-xs mr-6 ml-6 font-gothic text-black mt-4 md:text-lg/[22px] md:leadind-5 md:ml-20 md:text-left md:mr-20">Contrary to popular belief, Lorem Ipsum is not simply random text.
                ...
                The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from "de Finibus
                 Bonorum et Malorum" by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by
                  H. Rackham
            </p>

            <p class="text-justify leading-4 text-xs mr-6 ml-6 font-gothic text-black mt-4 md:text-lg/[22px] md:leadind-5 md:ml-20 md:text-left md:mr-20">It is a long established fact that a reader will be distracted 
            ...
            <p class="text-justify leading-4 text-xs mr-6 ml-6 font-gothic text-black mt-4 mb-16 md:text-lg/[22px] md:leadind-5 md:ml-20 md:text-left md:mr-20 md:mb-4">There are many variations of passages of Lorem Ipsum available,
                 but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.
                  ...
                  All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on
                   the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable.
                 The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.
            </p>

            <p class="text-justify hidden md:block leading-4 text-xs mr-6 ml-6 font-gothic text-black md:text-lg/[22px] md:leadind-5 md:ml-20 md:text-left md:mr-20">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text
                 ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived
                  not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 
                  1960s with the release of Letraset sheets containing Lorem Ipsum passages,
                 and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum
            ...
            <p class="text-justify hidden md:block leading-4 text-xs mr-6 ml-6 font-gothic text-black mt-4 md:text-lg/[22px] md:leadind-5 md:ml-20 md:text-left md:mr-20">Contrary to popular belief, Lorem Ipsum is not simply random text.
                 It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor 
                 at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going
                  through the cites of the word in classical literature, discovered the undoubtable source. Lorem Ipsum comes from sections 1.10.32 and 
                  1.10.33 of "de Finibus Bonorum et Malorum" (The Extremes of Good and Evil) by Cicero, written in 45 BC. This book is a treatise on the 
            ...
            <p class="text-justify hidden md:block leading-4 text-xs mr-6 ml-6 font-gothic text-black mt-4 md:text-lg/[22px] md:leadind-5 md:ml-20 md:text-left md:mr-20">It is a long established fact that a reader will be distracted 
                by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution
                 of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web 
                 page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy.
                 Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).
            ...
            <p class="text-justify hidden md:block leading-4 text-xs mr-6 ml-6 font-gothic text-black mt-4 mb-16 md:text-lg/[22px] md:leadind-5 md:ml-20 md:text-left md:mr-20">There are many variations of passages of Lorem Ipsum available,
                 but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.
                  If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. 
                  All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on
                   the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable.
                        ...
                        <div class="md:ml-12">
                            <ul class="list-disc text-white mt-6 ">
                                <div><h class="text-white text-base mb-2 md:text-xl font-inter md:font-normal">Quick Links</h></div>
                                    ...
                                    <li class="ml-6"><a @click="$dispatch('linkaction', {link: '{{route('gallery')}}', route: 'gallery'})"><p class="text-white font-light leading-6 text-xs mt-2 md:font-normal font-inter">Contact Us</p></a></li>
                                    <li class="ml-6"><a @click="$dispatch('linkaction', {link: '{{route('contact')}}', route: 'contact'})"><p class="text-white font-light leading-6 text-xs mt-2 md:font-normal font-inter">Gallery</p></a></li>
                            </ul>
                        </div>
                        <div class="md:ml-6">
                            <ul class="list-disc text-white mt-6 ">
